export type UIEvent = "ui:next"|"ui:prev"|"ui:toggleMic"|"ui:toggleCam"|"ui:switchCamera"|"ui:openSettings"|"ui:like"|"ui:report"|"ui:toggleBeauty"|"ui:updateBeauty"|"ui:changeMask";
