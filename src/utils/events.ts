export type UIEvent = "ui:next"|"ui:prev"|"ui:toggleMic"|"ui:toggleCam"|"ui:switchCamera"|"ui:openSettings"|"ui:like"|"ui:report"|"ui:toggleBeauty"|"ui:updateBeauty"|"ui:changeMask"|"ui:likeUpdate"|"ui:toggleRemoteAudio"|"ui:toggleMasks"|"ui:togglePlay"|"ui:toggleMirror"|"ui:upsell"|"filters:gender"|"filters:country"|"ui:openMessaging"|"ui:closeMessaging"|"rtc:pair"|"rtc:phase"|"rtc:remote-track";
