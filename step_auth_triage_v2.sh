...
# --- محلي: مسارات الراوت والموفّرين والمتغيرات
...
NEXTAUTH_VER="$(jq -r '.dependencies["next-auth"] // .dependencies["nextauth"] // empty' package.json 2>/dev/null || echo '')"

# ENV presence
REQ_VARS="NEXTAUTH_URL NEXTAUTH_SECRET GITHUB_ID GITHUB_SECRET GOOGLE_CLIENT_ID GOOGLE_CLIENT_SECRET AUTH_OKTA_ID AUTH_OKTA_SECRET EMAIL_SERVER EMAIL_FROM"
MISS=""
...
echo "NEXTAUTH_VERSION=${NEXTAUTH_VER:-unknown}"
